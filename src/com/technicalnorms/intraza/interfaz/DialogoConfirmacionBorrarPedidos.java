 ...
 *
 */
public class DialogoConfirmacionBorrarPedidos extends Activity
{	
	//Id y cliente de los pedidos a borrar
	...
	public void onCreate(Bundle savedInstanceState) 
	{
		...
		setContentView(R.layout.dialogo_confirmacion_borrar_pedidos);

		//Obtenemos los datos de los pedidos a borrar del intent
		...
		//Formamos el mensaje de aviso a mostar, mostramos la información de todos los pedidos a borrar
		...
		((TextView)findViewById(R.id.textoScrollMensajeAvisoDCBP)).setText(mensajeAviso);
			    
		//*******
		//BOTONES
		//*******
				
		siBtn = (Button)findViewById(R.id.siBotonDCBP);
		...
		noBtn = (Button)findViewById(R.id.noBotonDCBP);
	...
	private void returnSi()
	{
		...
		//Enviamos los id de los pedidos a borrar a la activity principal
		bundle = new Bundle();
